...
//     setCart((prevCart) => [...prevCart, product]); // Adding product to the cart state
//     console.log('Product added to cart:', product); // Debugging line to check if product is added
//   };
...
//       {/* Cart section to display items added */}
